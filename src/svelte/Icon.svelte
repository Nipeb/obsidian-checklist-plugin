...
{:else if name === 'eye-off'}
  <svg
    ...
    on:click={onClick}
    ><path
      d="M12 4C7 4 2.73 7.11 1 11.5 2.73 15.89 7 19 12 19c5 0 9.27-3.11 11-7.5C21.27 7.11 17 4 12 4zm0 12.5c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3zm6.36 9.19l-1.36 1.36L2.36 4.36l1.36-1.36 14.64 14.64z" /></svg>
{/if}
